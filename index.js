...
console.log(createMenuItem('Fries', 3, 'Sides'));
console.log(createMenuItem('Chocolate Shake', 4, 'Desserts'));
...
*/
reviews.push({name: 'Matt', rating: 1, feedback: "You must be out of your mind if you think I'm paying $18 for a burger."});
...
function getReviewByRating(array, ratingNum) {
  const ratingArray = [];
  for(i in array){
    if(ratingNum <= array[i].rating && array[i].rating < ratingNum + 1){
